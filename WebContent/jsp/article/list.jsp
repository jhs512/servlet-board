...
<body>
	...
	<ul>
		<li><%=(int) articleRows.get(0).get("id")%>번, <%=(String) articleRows.get(0).get("regDate")%>,
			<%=(String) articleRows.get(0).get("title")%></li>
		<li><%=(int) articleRows.get(1).get("id")%>번, <%=(String) articleRows.get(1).get("regDate")%>,
			<%=(String) articleRows.get(1).get("title")%></li>
		<li><%=(int) articleRows.get(2).get("id")%>번, <%=(String) articleRows.get(2).get("regDate")%>,
	...
	<ul>
		<%
			for (int i = 0; i < 3; i++) {
		%>
		<li><%=(int) articleRows.get(i).get("id")%>번, <%=(String) articleRows.get(i).get("regDate")%>,
